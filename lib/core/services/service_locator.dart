...
void setupLocator() {
  ...
  */
  locator.registerLazySingleton<LockerSubscriptionRequestDataSource>(
    () => LockerSubscriptionRequestDataSourceImpl(locator<Dio>()),
  );
  locator.registerLazySingleton<LockerSubscriptionRequestRepository>(
    () => LockerSubscriptionRequestRepositoryImpl(
      locator<LockerSubscriptionRequestDataSource>(),
    ),
  );
  locator.registerLazySingleton(
